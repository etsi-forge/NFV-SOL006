...
sed -r -i "s|<div class=\"app\">|<p>Commit: <a href=\"https://forge.etsi.org/rep/nfv/SOL006/commit/${CMT}\">$CMT</a>, Build:<a href=\"$BUILD_URL\">$BUILD_NUMBER</a></p><div class=\"app\">|g" src/yang/etsi-nfv.html
